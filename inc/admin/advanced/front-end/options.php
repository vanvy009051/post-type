	...
	<form id="of_form" method="post" action="<?php echo esc_attr($_SERVER['REQUEST_URI']) ?>" enctype="multipart/form-data">
		...
		<div id="main">
			...
			<div id="of-nav">
				...
				<div class="logo">
					<h3><?php echo 'Theme_Name' ?> <br />Theme Options<span><?php echo ('Version: ' . THEMEVERSION); ?></span></h3>
				</div>
				<div class="save_bar">
					<button id="of_save" type="button" class="button-primary"><?php _e('Save All Changes', '' . 'Theme_Name' . '-admin'); ?></button>
